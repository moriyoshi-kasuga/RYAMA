...
urlpatterns = [
    ...
    path("markdowns/<int:id>", views.page_file, name="file"),
    path("api/file/<int:id>", views.view_file, name="getFile"),
    path("api/preview/", views.preview_file, name="preview"),
    path("api/save/", views.save_file, name="save"),
]
